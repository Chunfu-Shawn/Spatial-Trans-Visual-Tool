...
export default function ChartToolbar(props) {
  ...
  return (
    <>
      ...
      {props.onDragMode && (
        <Tooltip title={'Lasso Select'}>
          <IconButton
            edge={false}
            size={'small'}
            className={dragmode === 'lasso' ? active : ''}
        ...
        <Tooltip title={'Box Select'}>
          ...
          >
            <PhotoSizeSelectSmallIcon
              className={dragmode === 'select' ? active : ''}
            />
          </IconButton>
        </Tooltip>
      )}
      ...
      {props.onEditSelection && (
        <Tooltip title={'Append to selection'}>
          <IconButton
            edge={false}
            size={'small'}
            aria-label="Append to selection"
      ...
      {props.is3d && (
        <Tooltip title={props.animating ? 'Pause' : 'Animate'}>
          <IconButton
            edge={false}
            size={'small'}
      ...
      {props.onShowLabels && (
        <Tooltip title={'Show Categorical Labels'}>
          <IconButton
            edge={false}
            size={'small'}
      ...
      {props.is3d && props.onShowAxis && (
        <Tooltip title={'Show Axis'}>
          <IconButton
            edge={false}
            size={'small'}
            className={showAxis ? active : ''}
      ...
      {props.is3d && props.onShowFog && (
        <Tooltip title={'Show Fog'}>
          <IconButton
            edge={false}
            size={'small'}
            className={props.showFog ? active : ''}
            aria-label="Show Fog"
            onClick={() => onShowFog()}
          >
            <CloudQueueIcon />
